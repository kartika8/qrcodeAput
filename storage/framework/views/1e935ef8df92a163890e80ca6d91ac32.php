...
@media (max-width: 600px) {
    ...
    <body>
        <div class="container">
            <div class="row mt-5">
                <h2>Form QR Code</h2>
                <form class="form-inline" action="<?php echo e(route('store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                ...
                <table class="table">
                    ...
                    <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                            <a href="<?php echo e(route('generate',$data->id)); ?>" class="btn btn-primary">Generate</a>
                        </td>
                      </tr>
...
<?php /**PATH C:\laragon\www\kriptografi-qrcode\resources\views/welcome.blade.php ENDPATH**/ ?>